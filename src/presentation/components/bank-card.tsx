...
import { deleteRecord, updateRecord } from "@/presentation/actions/crud-actions"
...
export function BankCard({
  ...
  const [titularTipo, setTitularTipo] = useState(cuenta.titularTipo ?? "negocio")
  const [titularNombre, setTitularNombre] = useState(cuenta.titularNombre ?? "")
  ...
  const getTheme = () => {
    ...
    if (cuenta.tipo === "banco") {
      if (nameUpper.includes("BBVA")) {
        return {
          gradient: "bg-gradient-to-br from-slate-950 via-blue-950 to-indigo-950 text-blue-100 border-blue-800/40 shadow-xs",
      ...
      if (nameUpper.includes("BANAMEX") || nameUpper.includes("CITI")) {
        return {
          gradient: "bg-gradient-to-br from-slate-950 via-rose-950 to-blue-950 text-rose-100 border-rose-800/40 shadow-xs",
      ...
      return {
        gradient: "bg-gradient-to-br from-zinc-950 via-slate-900 to-teal-950 text-teal-100 border-teal-800/40 shadow-xs",
    ...
    if (cuenta.tipo === "efectivo") {
      return {
        gradient: "bg-gradient-to-br from-amber-950 via-neutral-950 to-stone-900 text-amber-100 border-amber-800/40 shadow-xs",
    ...
    return {
      gradient: "bg-gradient-to-br from-neutral-950 via-slate-900 to-zinc-950 text-zinc-100 border-zinc-700/40 shadow-xs",
  ...
  const ownerLabel = cuenta.titularTipo ? cuenta.titularTipo.toUpperCase() : "NEGOCIO"
        ...
        <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Modifica el propietario (Proveedor, Cliente, Familiar, Trabajador), banco y saldo.
              </DialogDescription>
            </DialogHeader>

            <form onSubmit={handleSave} className="space-y-4 py-2">
              <div className="space-y-1.5">
                <Label htmlFor="edit-nombre">Nombre Identificador de la Cuenta</Label>
                <Input
                  id="edit-nombre"
                  value={nombre}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  <Label htmlFor="edit-titularTipo">Propietario / Titular</Label>
                  <SelectNative
                    id="edit-titularTipo"
                    value={titularTipo}
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="edit-titularNombre">Nombre del Propietario</Label>
                  <Input
                    id="edit-titularNombre"
                    value={titularNombre}
                    onChange={(e) => setTitularNombre(e.target.value)}
                    placeholder="Ej. Don Carlos Burelo"
                  />
                </div>
              </div>
